...
func AddImages(cfg *HandlerConfig) (string, string, gin.HandlerFunc) {
	return "POST", "/album/:slug/images", p.Preload(
		cfg.Config, &p.Option{Login: p.Login, Bind: p.Other, Preloads: []string{"UserGuild"}}, nil,
		func(c *gin.Context, u *utils.User, r *struct {
			...
			if album.Protected &&
				!u.HasAnyRole(utils.Admin, utils.GalleryAdmin) &&
				album.UserID != u.ID &&
				(album.GuildID == nil || u.UserGuild == nil || *album.GuildID != u.UserGuild.GuildID) {
